      ...
      <Container>
        <View py={4}>
          <Text>
            ...
            <br />
            <br /> OVERVIEW <br />
            {` This website is operated by Surf City Home Repair Service.
            Throughout the site, the terms “we”, “us” and “our” refer to Surf
            City Home Repair Service. Surf City Home Repair Service offers this
            ...
            <br />
            SECTION 1 - TERMS
            <br /> By agreeing to these Terms of Service, you represent that you
            ...
            any of your minor dependents to use this site. <br />
            <br />
            ...
            <br /> We reserve the right, but are not obligated, to limit the
            ...
            corrected. <br />
            <br /> SECTION 6 - OPTIONAL TOOLS <br />
            ...
            <br />
            <br /> SECTION 8 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS{" "}
            <br />
            ...
            <br /> You agree that from time to time we may remove the service
            for indefinite periods of time or cancel the service at any time,
            without notice to you.
            <br /> Y
            {`ou expressly agree that your use of, or inability to use,
            ...
            <br />
            {` In no case shall Surf City Home Repair Service, our directors,
            ...
            {`You agree to indemnify, defend and hold harmless Surf City Home
            Repair Service and our parent, subsidiaries, affiliates, partners,
            ...
            <br />
            <br />
            SECTION 14 - SEVER A BILITY <br />
            {` In the event that any provision of thes void or sf Service is
            determined to be unlawful, void or unenforceable, such provision
            shall nonetheless be enforceable to the fullest extent permitted by
            applicable law, and thee Trms orceable portion shall be deemed to be
            severed from these Ter andms Service, such determination shall not
            ...
            <br />
            <br /> SECTION 16 - ENTIRE AGREEMENT <br />
            ...
            <br />
            <br />
            SECTION 17 - GOVERNING LAW <br />
            {`These Terms of Service and any sep
            agreements whereby we provide you Services shall be governed by an
            construed in accordance with the laws of United States. SECTION 18
            CHANGES TO TERMS OF SERVICE You can review the most current versio
            of the Terms of Service at any time at this page. We reserve the
            right, at our sole discretion, tou pdate, change or replace any of
            these Terms of Service by posting updates and chang website. It is
            your responsibility to check our w ebsite periodical for changes.
            ...
            <br />
            <br />
            SECTION 19 - CONTACT INFORMATION <br />
            Questions about the Terms orcs sent to us at sent to us at
            surfcitypainters@gmail.com.
          </Text>
        </View>
      </Container>
    </>

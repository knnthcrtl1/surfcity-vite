      ...
      <Container>
        <View py={4}>
          <Text>
            ...
            surfcitypainters.com (the “Site”).`}{" "}
            <br />
            <br />{" "}
            {`Thank you for choosing to be part of our community at SURF
            CITY HOME REPAIR SERVICE, doing business as Surf City
            Painters (“Surf City”, “we”, “us”, or “our”). We are committed to
            ...
            us at surfcitywebmaster@gmail.com.`}
            <br /> <br />
            {`When you visit our website https://www.surfcitypainters.com, and use
            our services, you trust us with your personal information. We take
            your privacy very seriously. In this privacy policy, we describe our
            ...
            website (such as https://www.surfcitypainters.com), and/or any
            ...
            Order Information.`}
            <br />
            <br /> {`How do we use your personal information? We use the Order`}
            <br />
            ...
            described above. We use Google Analytics to help us understand how
            ...
            us by email at beautyfxink@gmail.com or by mail using the details
            provided below: `}
            <br />
            <br />
            {`SURF CITY HOME REPAIR SERVICE`}
            <br />
            {`    [Re: Privacy Compliance Officer] SURF CITY HOME REPAIR SERVICE, 5904
            Warner Ave Suite 116, Huntington Beach CA 91324, United States`}
          </Text>
        </View>
      </Container>
    </>
